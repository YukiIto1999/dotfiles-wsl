...
| username、home、checkout path、環境系repositoryの置き場所を変える | [`workstation/module.nix`](../../workstation/module.nix)の`dotfiles.workstation` | identity migrationとして扱い、通常rebuildと混ぜない。checkoutの場所を変えるときは[checkoutの移動](../operations/checkout-relocation.md)に従う |

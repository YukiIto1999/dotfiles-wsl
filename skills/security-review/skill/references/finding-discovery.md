...
### Code Diff Workflow
If the scan target is for a targeted code-diff, follow the procedure in `code-diff-scan.md`.

### Repository-Wide Workflow

If the scan target is repository-wide, follow the procedure in `repository-wide-scan.md` and every required reference it lists.

...
let
  ...
  '';
  front = hostConfig.dotfiles.platform.mcp.fronts.crawl4ai;
  target = hostConfig.dotfiles.platform.mcp.targets.crawl4ai;
  ...
  mkIsolationProjection =
    ...
    let
      ...
      isolatedTarget = evaluation.config.dotfiles.platform.mcp.targets.crawl4ai;
    in
    builtins.toJSON {

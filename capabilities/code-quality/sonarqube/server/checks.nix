...
let
  ...
  service = hostConfig.dotfiles.platform.containers.services.sonarqube;
  ...
  ownerAssertionDefinitions = builtins.filter (
    definition:
    lib.hasSuffix "/capabilities/code-quality/sonarqube/database/module.nix" (toString definition.file)
